#ifndef AUTOPILOT_MPC_CONTROL_MODE_WAYPOINT_H
#define AUTOPILOT_MPC_CONTROL_MODE_WAYPOINT_H
...
class Waypoint final : protected ControlMode {
public:
...
private:
  ...
  static uint8_t constraint_violations(const Aircraft *a);

  // Compile checks
  CHECK_GT(config::mpc::optimization::MAX_OBJECTIVES, NUM_OBJECTIVES);
};

#endif // AUTOPILOT_MPC_CONTROL_MODE_WAYPOINT_H